INSERT INTO users (USER_ID, USER_NAME, USER_PASSWORD, USER_NICKNAME, USER_ACTIVATED)
VALUES ( 1, 'admin', '$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi', 'bomsbro', 1);
INSERT INTO users (USER_ID, USER_NAME, USER_PASSWORD, USER_NICKNAME, USER_ACTIVATED)
VALUES ( 2, 'user', '$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi', '재헌', 1);

INSERT INTO authority (AUTH_ID, AUTH_NAME)
VALUES (1, 'ROLE_USER');
INSERT INTO authority (AUTH_ID, AUTH_NAME)
VALUES (2, 'ROLE_ADMIN');

INSERT INTO user_authority (user_id, AUTH_ID)
VALUES (1, 1);
INSERT INTO user_authority (user_id, AUTH_ID)
VALUES (1, 2);

INSERT INTO post_category (pca_id, pca_name, pca_order)
VALUES (1, '첫번째 게시판', 1);
INSERT INTO post_category (pca_id, pca_name, pca_order)
VALUES (2, '두번째 게시판', 2);
INSERT INTO post_category (pca_id, pca_name, pca_order)
